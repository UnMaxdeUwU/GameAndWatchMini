...
/// <summary>
/// Handles persistent storage and retrieval of leaderboard entries.
/// Scores are saved to a dedicated JSON file in persistent data path.
/// </summary>
public class LeaderboardController
{
    ...
    /// <summary>
    /// Adds a new entry to the leaderboard and saves immediately.
    /// </summary>
